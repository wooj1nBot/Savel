...
public class MyFCMService extends FirebaseMessagingService {
        ...
        super.onMessageReceived(remoteMessage);
            ...
            if (db != null && mAuth != null && remoteMessage.getData().size() > 0) {
                if (data.containsKey("travelId")) {
                    ...
                    String travelId = data.get("travelId");
                    ...
                    if (!mainisnotifi_off) {
                        ...
                        boolean isnotifi_off = false;
                        JSONObject jsonObject = null;
                        if (!jsonstring.equals("")) {
                            try {
                                jsonObject = new JSONObject(jsonstring);
                                isnotifi_off = jsonObject.getBoolean(travelId);
    ...
    private void sendFriendNotification(Map<String,String> data) {
        ...
        intent.putExtra("travel", data.get("travelId"));
        ...
        Notification summaryNotification =
                new NotificationCompat.Builder(this, channelId)
                        .setSmallIcon(R.drawable.map_48px)
                        .setContentText("Travel Notification")
                        .setAutoCancel(true)
                        .setSound(defaultSoundUri)
                        .setPriority(NotificationCompat.PRIORITY_HIGH)
                        .setDefaults(DEFAULT_SOUND | DEFAULT_VIBRATE)
